...
exports.query = function(opt, callback){
    ...
    var params = 'recordtype=' + def.recordtype+ '&library_id=' + lib_id + '&kind=simple&word=' + encodeURIComponent(word) + '&cmatch=' + cmatch + '&searchtimes=1&type=title&orderby=pubdate_date&ordersc=desc&size=' + size;
